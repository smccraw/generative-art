...
export function HomePage() {
    return <div className="about-content">
        ...
        <p>If you have any comments, feedback or especially any pointers to new and interesting techniques, please
            drop me a line at <a href='mailto: smccraw116@gmail.com'>smccraw116@gmail.com</a>. If you want to take
            a look at the code (React app + P5.js), the github project is <a href='https://github.com/smccraw/generative-art'>https://github.com/smccraw/generative-art</a>.
        </p>
        ...
        <p>Also note that due to the amount of large images and large image generating canvases used here,
            this site is not very mobile friendly. Best viewed on a laptop of full PC.
        </p>
        <br />
